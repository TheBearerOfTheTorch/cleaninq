...
import 'package:cleaninq/services/middlewares/shared_components.dart';
...
class _SharedProfileState extends State<SharedProfile> {
  ...
  String filePath = 'profiles/${DateTime.now().microsecondsSinceEpoch}';

  //objects
  SharedProfileFirebase profile = SharedProfileFirebase();
  ...
  Future uploadImage(
    ...
    imageUrl = await (await _uploadTask!.whenComplete(() => null))
        .ref
        .getDownloadURL();
    await profile.profileUpdating(name, address, contact, model, download);
  ...
  Widget build(BuildContext context) {
    ...
    final Stream _userProfile = FirebaseFirestore.instance
        .collection('users')
        .doc(currentUser!.uid)
        .snapshots();
          ...
          Form(
            ...
            child: ListView(
              ...
              children: [
                ...
                TextFormField(
                  validator: (val) =>
                      val!.isNotEmpty ? null : "Please fill in this option",
                  controller: _aboutController,
                  decoration: InputDecoration(
                    prefixIcon: Icon(FontAwesomeIcons.modx),
                    hintText: "Why are you on cleaninq",
